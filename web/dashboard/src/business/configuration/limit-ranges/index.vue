<template>
  <layout-content header="Limit Ranges">
    ...
    <complex-table :data="data" @search="search" v-loading="loading" :pagination-config="paginationConfig" :selects.sync="selects" element-loading-background="rgba(255, 255, 255, 0.8)"
